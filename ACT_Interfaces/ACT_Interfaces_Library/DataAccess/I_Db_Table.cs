...
// ***********************************************************************
// <copyright file="I_DbTable.cs" company="IVolt, LLC">
//     Copyright ©  2022
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace ACT.Core.Interfaces.DataAccess
{
    ...
    public interface I_Db_Table : I_Core, IComparable
    {
        /// <summary>
        ...
        /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        bool AddRelationship(I_Db_Relationship Relationship);
        /// <summary>
        ...
        I_Db_Relationship GetRelationship(string Name, bool IgnoreCase);
        /// <summary>
        /// Gets the relationship.
        /// </summary>
        /// <param name="Index">The index.</param>
        /// <returns>I_DbRelationship.</returns>
        I_Db_Relationship GetRelationship(int Index);
        /// <summary>
        /// Gets all relationships.
        /// </summary>
        /// <value>All relationships.</value>
        BindingList<I_Db_Relationship> AllRelationships { get; }
